...
@section('content')
    <div class="container">
        <div>
            <h2 style="font-weight: 600">Thông tin người dùng: <span>{{ auth()->user()->name }}</span></h2>
        </div>
    </div>
        ...
        <div>
            <div class="col-lg-8">
                ...
                <div style="border-bottom: 1px solid #ddd">
                    ...
                    <div>
                        <form action="{{ route('student.update',['student' => auth()->user()]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form" >
