...
<header>
    <nav class="navbar-inner">
        <div class="head" style="display: flex;justify-content: space-between;">
            ...
            <div style="margin: auto 0;">Xin chào {{ auth()->user()->email  }}(<a href="{{ route('lecturer.detail') }}">Thông tin tài khoản</a>)</div>
        </div>
    </nav>
</header>
<main>
        ...
        <div class="news" style="width: 70%">
            <div class="block-courses-recently" >
                <div class="header-courses">
                    <div>
                        <h3 style="margin: 0;padding: 0">Các khóa học kì này</h3>
                    </div>
                                ...
                                <div class="col-sm-4 card" >
                                    <div class="card text-white">
                                        ...
                                        <div class="card-img-overlay">
                                            <div>
                                                <a href="{{ route('lecturer.course.detail',['id' => $course->id]) }}" class="subs">{{ $course->code }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="section">
                        ...
                        <div>
                            ...
                            <div style="margin-left: 50px">
                                ...
                                <a href="{{ route('lecturer.post.detail',['slug' => $post->slug]) }}" style="color: #0B90C4">Xem tiếp nội dung chủ đề này</a>
                            </div>
                        </div>
                    </div>
